...
namespace MDSound
{
    public class ym3438_const
    {
        // logsin table
        public static ushort[] logsinrom = new ushort[256]{
        ...
        // exp table
        public static ushort[] exprom = new ushort[256]
        {
        ...
        // note table
        public static uint[] fn_note = new uint[16] { 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 3, 3, 3, 3, 3, 3 };

        // Env Gen
        public static uint[][] eg_stephi = new uint[4][]{
            new uint[]{ 0, 0, 0, 0 },
            new uint[]{ 1, 0, 0, 0 },
            new uint[]{ 1, 0, 1, 0 },
            new uint[]{ 1, 1, 1, 0 }
        };
        public static byte[] eg_am_shift = { 7, 3, 1, 0 };

        // Phase Gen
        public static uint[] pg_detune = new uint[8] { 16, 17, 19, 20, 22, 24, 27, 29 };

        
        public static uint[][] pg_lfo_sh1 = new uint[8][]{
            new uint[8]{ 7, 7, 7, 7, 7, 7, 7, 7 },
            new uint[8]{ 7, 7, 7, 7, 7, 7, 7, 7 },
            new uint[8]{ 7, 7, 7, 7, 7, 7, 1, 1 },
            new uint[8]{ 7, 7, 7, 7, 1, 1, 1, 1 },
            new uint[8]{ 7, 7, 7, 1, 1, 1, 1, 0 },
            new uint[8]{ 7, 7, 1, 1, 0, 0, 0, 0 },
            new uint[8]{ 7, 7, 1, 1, 0, 0, 0, 0 },
            new uint[8]{ 7, 7, 1, 1, 0, 0, 0, 0 }
        };

        public static uint[][] pg_lfo_sh2 = new uint[8][]{
            new uint[8]{ 7, 7, 7, 7, 7, 7, 7, 7 },
            new uint[8]{ 7, 7, 7, 7, 2, 2, 2, 2 },
            new uint[8]{ 7, 7, 7, 2, 2, 2, 7, 7 },
            new uint[8]{ 7, 7, 2, 2, 7, 7, 2, 2 },
            new uint[8]{ 7, 7, 2, 7, 7, 7, 2, 7 },
            new uint[8]{ 7, 7, 7, 2, 7, 7, 2, 1 },
            new uint[8]{ 7, 7, 7, 2, 7, 7, 2, 1 },
            new uint[8]{ 7, 7, 7, 2, 7, 7, 2, 1 }
        };
        //Address Decod
        public static uint[] op_offset = new uint[12] {
            0x000, /* Ch1 OP1/OP2 */
            0x001, /* Ch2 OP1/OP2 */
            0x002, /* Ch3 OP1/OP2 */
            0x100, /* Ch4 OP1/OP2 */
        ...
        public static uint[] ch_offset = new uint[6]
        {
            0x000, /* Ch1 */
            0x001, /* Ch2 */
            0x002, /* Ch3 */
        ...
        public static uint[] lfo_cycles = { 108, 77, 71, 67, 62, 44, 8, 5 };

        public static uint[][][] fm_algorithm = new uint[4][][] {
                new uint[6][]{
                    new uint[8]{ 1, 1, 1, 1, 1, 1, 1, 1 }, /* OP1_0         */
                    new uint[8]{ 1, 1, 1, 1, 1, 1, 1, 1 }, /* OP1_1         */
                    new uint[8]{ 0, 0, 0, 0, 0, 0, 0, 0 }, /* OP2           */
                    new uint[8]{ 0, 0, 0, 0, 0, 0, 0, 0 }, /* Last operator */
                    new uint[8]{ 0, 0, 0, 0, 0, 0, 0, 0 }, /* Last operator */
                    new uint[8]{ 0, 0, 0, 0, 0, 0, 0, 1 }  /* Out           */
                },
                new uint[6][]{
                    new uint[8]{ 0, 1, 0, 0, 0, 1, 0, 0 }, /* OP1_0         */
                    new uint[8]{ 0, 0, 0, 0, 0, 0, 0, 0 }, /* OP1_1         */
                    new uint[8]{ 1, 1, 1, 0, 0, 0, 0, 0 }, /* OP2           */
                    new uint[8]{ 0, 0, 0, 0, 0, 0, 0, 0 }, /* Last operator */
                    new uint[8]{ 0, 0, 0, 0, 0, 0, 0, 0 }, /* Last operator */
                    new uint[8]{ 0, 0, 0, 0, 0, 1, 1, 1 }  /* Out           */
                },
                new uint[6][]{
                    new uint[8]{ 0, 0, 0, 0, 0, 0, 0, 0 }, /* OP1_0         */
                    new uint[8]{ 0, 0, 0, 0, 0, 0, 0, 0 }, /* OP1_1         */
                    new uint[8]{ 0, 0, 0, 0, 0, 0, 0, 0 }, /* OP2           */
                    new uint[8]{ 1, 0, 0, 1, 1, 1, 1, 0 }, /* Last operator */
                    new uint[8]{ 0, 0, 0, 0, 0, 0, 0, 0 }, /* Last operator */
                    new uint[8]{ 0, 0, 0, 0, 1, 1, 1, 1 }  /* Out           */
                },
                new uint[6][]{
                    new uint[8]{ 0, 0, 1, 0, 0, 1, 0, 0 }, /* OP1_0         */
                    new uint[8]{ 0, 0, 0, 0, 0, 0, 0, 0 }, /* OP1_1         */
                    new uint[8]{ 0, 0, 0, 1, 0, 0, 0, 0 }, /* OP2           */
                    new uint[8]{ 1, 1, 0, 1, 1, 0, 0, 0 }, /* Last operator */
                    new uint[8]{ 0, 0, 1, 0, 0, 0, 0, 0 }, /* Last operator */
                    new uint[8]{ 1, 1, 1, 1, 1, 1, 1, 1 }  /* Out           */
            }
        };
